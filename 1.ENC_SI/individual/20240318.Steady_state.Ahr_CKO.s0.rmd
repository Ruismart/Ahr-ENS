...
```{r fig.height=6.5, fig.width=9, message=FALSE, warning=FALSE}
par(mfrow=c(2,3))
...
```{r fig.width=11.55, fig.height=10}
...
```{r fig.height=6.5, fig.width=10, message=FALSE, warning=FALSE}
par(mfrow=c(2,3))
...
```{r  fig.width=9.5, fig.height=6.4}
...
```{r fig.height=5.5, fig.width=15.5}
markers.new.ss <- list(EMN=c("Chat","Bnc2","Tox","Ptprt",
                       "Gfra2","Oprk1","Adamtsl1", 
                       "Fbxw15","Fbxw24","Chrna7",
                       "Satb1","Itga6","Cntnap5b",
